...
<div className="columns">
    ...
    <div className="field"><div className="control">
       <input className="input" type="text" status={this.props.status} wordid={this.props.wordId}  name="demo-name" id="demo-name" defaultValue={this.props.en} placeholder="EN" />
    </div></div>
    </div>
    <div className="column is-3">
    <input placeholder="example in EN" className="input" type="text" name="demo-name" id="demo-name" defaultValue={this.props.exampleUseEn ? this.props.exampleUseEn : this.props.exampleUse } rows="1"></input>
  </div>
    <div className="column is-2">
     <input className="input" type="text" name="demo-name" id="demo-name" defaultValue={this.props.vn} placeholder="VN" />
    </div>
  <div className="column is-3">
    <input placeholder="example in VN" className="input" type="text" name="demo-name" id="demo-name" defaultValue={this.props.exampleUseVn ? this.props.exampleUseVn : null} rows="1"></input>
  </div>
  <div className="column is-3">
